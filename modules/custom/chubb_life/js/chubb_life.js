jQuery(document).ready(function($){
    ...
    function sale_sample_data(){
        jQuery('input[name="referenceNumber"]').val('referenceNumber');
        ...
        jQuery('select[name="taxResidency"]').val('HK');
        jQuery('input[name="taxResidencyTin"]').val('A123456(7)');
        ...
        jQuery('select[name="occupations_code"]').val('A020101');
        ...
        jQuery('select[name="customer_insured_marital_status"]').val('2');
        jQuery('select[name="customer_insured_nationality"]').val('HK');
        jQuery('select[name="customer_insured_taxResidency"]').val('HK');
        jQuery('input[name="customer_insured_taxResidencyTin"]').val('B123443(0)');
        ...
        jQuery('select[name="customer_insured_occupations_code"]').val('A090101');
        ...
        jQuery('input[name="agents_code"]').val('agents_code');
        jQuery('select[name="billing_type"]').val('CUP');
        jQuery('input[name="tokenized_card_number"]').val('tokenized_card_number');
