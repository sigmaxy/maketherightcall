...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['phptemp'] = [
      ...
      '#states' => [
        'visible' => [
          ':input[value="cache_to_phpTemp"]' => ['checked' => TRUE],
        ],
      ],
    ];
    $form['phptemp']['phptemp_limit'] = [
      '#title' => $this->t("PHPTemp memory cache size"),
      '#description' => $this->t("The limit before which PhpSpreadsheet will still use memory instead of disk for cell caching. Value in MB (only give a numerical value)."),
      '#type' => 'textfield',
    ...
    $form['apc'] = [
      ...
      '#states' => [
        'visible' => [
          ':input[value="cache_to_apc"]' => ['checked' => TRUE],
        ],
      ],
    ];
    $form['apc']['apc_cachetime'] = [
    ...
    $form['memcache'] = [
      ...
      '#states' => [
        'visible' => [
          ':input[value="cache_to_memcache"]' => ['checked' => TRUE],
        ],
      ],
    ];
    $form['memcache']['memcache_host'] = [
    ...
    $form['memcache']['memcache_cachetime'] = [
