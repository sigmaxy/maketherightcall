...
jQuery UI resizable library for any themes and modules that require it.

  - jQuery UI [Resizable documentation](https://jqueryui.com/resizable/)
  - jQuery UI [Resizable API documentation](https://api.jqueryui.com/resizable/)
...
2.  Change any references in your theme or module from
    `core/jquery.ui.resizable` to `jquery_ui_resizable/resizable`
...
### Related modules
  ...
  - [jQuery UI Dialog](https://www.drupal.org/project/jquery_ui_dialog)
