...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape' || e.key === 'Esc') {
        if (props.mtrc.areAnySubNavsOpen()) {
          props.mtrc.closeAllSubNav();
        } else {
   ...
   */
  Drupal.behaviors.mtrcNavigation = {
    attach(context) {
