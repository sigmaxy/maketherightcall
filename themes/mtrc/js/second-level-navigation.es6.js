...
((Drupal) => {
  const { isDesktopNav } = Drupal.mtrc;
  ...
  Drupal.mtrc.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.mtrc.isDesktopNav()) return;
  ...
  Drupal.mtrc.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.mtrc.areAnySubNavsOpen = areAnySubNavsOpen;
