...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape' || e.key === 'Esc') {
        if (props.chubb.areAnySubNavsOpen()) {
          props.chubb.closeAllSubNav();
        } else {
   ...
   */
  Drupal.behaviors.chubbNavigation = {
    attach(context) {
