...
((Drupal) => {
  const { isDesktopNav } = Drupal.chubb;
  ...
  Drupal.chubb.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.chubb.isDesktopNav()) return;
  ...
  Drupal.chubb.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.chubb.areAnySubNavsOpen = areAnySubNavsOpen;
